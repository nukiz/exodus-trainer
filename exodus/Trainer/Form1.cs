...
namespace testui
{
    public partial class Form1 : Form
    {
        ...
        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label5.Show();
                meme.WriteMemory("base+70CC47", "bytes", "75 5D");
            }
            else
            {
                arraylist.label5.Hide();
        ...
        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label4.Show();
                meme.WriteMemory("base+58FC46", "bytes", "74 1C");
            }
            else
            {
                arraylist.label4.Hide();
        ...
        private void checkBox5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label9.Show();
                meme.WriteMemory("base+5ADB55", "bytes", "75 68");
            }
            else
            {
                arraylist.label9.Hide();
        ...
        private void checkBox6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label8.Show();
                meme.WriteMemory("base+6AC30B", "bytes", "75 1C");
            }
            else
            {
                arraylist.label8.Hide();
        ...
        private void checkBox9_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label17.Show();
                meme.WriteMemory("base+6A9B57", "bytes", "75 09");
            }
            else
            {
                arraylist.label17.Hide();
        ...
        private void checkBox10_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label19.Show();
                meme.WriteMemory("base+5A2A31", "bytes", "75 5F");
            }
            else
            {
                arraylist.label19.Hide();
        ...
        private void checkBox12_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label18.Show();
                meme.WriteMemory("base+6A9AA4", "bytes", "74 0E");
            }
            else
            {
                arraylist.label18.Hide();
        ...
        private void checkBox15_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label11.Show();
                meme.WriteMemory("base+70CC4F", "bytes", "74 05");
            }
            else
            {
                arraylist.label11.Hide();
        ...
        private void checkBox17_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label24.Show();
                meme.WriteMemory("base+CAC9E0", "bytes", "90 90");
            }
            else
            {
                arraylist.label24.Hide();
        ...
        private void checkBox18_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label28.Show();
                meme.WriteMemory("base+6A8AED", "bytes", "75 26");
            }
            else
            {
                arraylist.label28.Hide();
        ...
        private void checkBox19_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label23.Show();
                meme.WriteMemory("base+6A89F8", "bytes", "75 0D");
            }
            else
            {
                arraylist.label23.Hide();
        ...
        private void checkBox20_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label25.Show();
                meme.WriteMemory("base+6A8A92", "bytes", "75 22");
            }
            else
            {
                arraylist.label25.Hide();
        ...
        private void checkBox22_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label27.Show();
                meme.WriteMemory("base+6A9CA2", "bytes", "75 05");
            }
            else
            {
                arraylist.label27.Hide();
        ...
        private void checkBox23_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label32.Show();
                meme.WriteMemory("base+6A3EBF", "bytes", "90 90 90");
            }
            else
            {
                arraylist.label32.Hide();
        ...
        private void checkBox24_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label29.Show();
                meme.WriteMemory("base+6A9AB2", "bytes", "74 03");
            }
            else
            {
                arraylist.label29.Hide();
        ...
        private void checkBox26_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label16.Show();
                meme.WriteMemory("base+19FDD9", "bytes", "90 90");
            }
            else
            {
                arraylist.label16.Hide();
        ...
        private void checkBox27_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label22.Show();
                meme.WriteMemory("base+6FAAB5","bytes", "90 90");
            }
            else
            {
                arraylist.label22.Hide();
                meme.WriteMemory("base+6FAAB5", "bytes", "75 0B");
            }
        }
        ...
        private void checkBox29_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                arraylist.label14.Show();
                meme.WriteMemory("base+6FAAB5", "bytes", "74 0B");
            }
            else
            {
                arraylist.label14.Hide();
                meme.WriteMemory("base+6FAAB5", "bytes", "75 0B");
            }
        }
